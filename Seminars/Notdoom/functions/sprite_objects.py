...
class Sprites:
    def __init__(self):
        self.sprite_types = {
            ...
            # 'devil': [pygame.image.load(f'functions/sprites/devil/{i}.png').convert_alpha() for i in range(8)] пока что не работает
        }
        self.list_of_objects = [
            ...
            # SpriteObject(self.sprite_types['devil'], False, (7, 4), -0.2, 0.7), пока что не работает
        ]
